...
module.exports = {
  ...
  async execute(message,args,client) {
    ...
    let helpEmbed = new MessageEmbed()
      ...
      .setFooter( client.user.username +`Type: ${prefix}help <Command>  for more information!`, "https://cdn.discordapp.com/attachments/807050299935031306/886813416822558790/rp.gif")
      .setColor("#c219d8");
